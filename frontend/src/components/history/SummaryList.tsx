    ...
    <div className={`flex flex-col h-full space-y-4 ${className}`}>
      ...
      <div className="relative flex-shrink-0">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border bg-white text-gray-800 border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
        />
      </div>
